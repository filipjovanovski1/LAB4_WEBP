...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers("/", "/home", "/assets/**", "/register", "/css/**", "/js/**")
                        .permitAll()
    ...
    public UserDetailsService userDetailsService() {
        UserDetails user1 = User.builder()
                .username("ficoo")
                .password(passwordEncoder.encode("Filipj123"))
                .roles("USER")
                .build();
        UserDetails user2 = User.builder()
                .username("berizco")
                .password(passwordEncoder.encode("B3R1Z"))
                .roles("USER")
                .build();
        UserDetails user3 = User.builder()
                .username("majaan")
                .password(passwordEncoder.encode("anevska12"))
                .roles("USER")
                .build();
        UserDetails admin = User.builder()
                .username("admin")
                .password(passwordEncoder.encode("78951"))
                .roles("ADMIN")
                .build();
